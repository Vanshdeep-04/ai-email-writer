...
function createToneSelector(){
    ...
    select.classList.add('asi-tone-selector');

    // Basic Gmail-like styling
    select.style.marginRight = '8px';
    select.style.padding = '6px 10px';
    select.style.border = '1px solid #dcdcdc';
    select.style.borderRadius = '4px';
    select.style.backgroundColor = '#f1f3f4';
...
const observer=new MutationObserver((mutations)=>{
    for(const mutation of mutations){
        ...
        if(hasComposeElements){
            ...
            // I am making a 500 msec (1/2 sec) delay to ensure that everything is loaded before injection button
